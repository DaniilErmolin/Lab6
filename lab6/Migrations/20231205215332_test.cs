        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vouchers_AdditionalServices_AdditionalServiceId",
                        column: x => x.AdditionalServiceId,
                        principalTable: "AdditionalServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vouchers_Employees_EmployessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vouchers_AdditionalServiceId",
                table: "Vouchers",
                column: "AdditionalServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Vouchers_EmployessId",
                table: "Vouchers",
                column: "EmployessId");
        }
